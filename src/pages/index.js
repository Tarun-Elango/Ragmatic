...
export default function Home() {
  ...
  return (
    ...
    <div style={{ display: 'flex', alignItems: 'center', width: '100%', maxWidth: '800px' }}>
        ...
        <Button onClick={handleBackButtonClick} style={{ backgroundColor: '#fa7970', marginLeft:'15px', border:'black' }}>Back</Button>
        
        <Button onClick={handleBackButtonClick} style={{ backgroundColor: '#fa7970', marginLeft:'15px', border:'black' }}>Log Out</Button>
    </div>

    <div style={{ borderRadius: '10px', backgroundColor: '#89929b', marginTop: '10px', border: '1px solid black', padding: '10px', width: '100%', maxWidth: '800px', height: '70vh', overflowY: 'auto' }}>
